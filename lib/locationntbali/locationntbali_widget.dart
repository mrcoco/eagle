...
import '../locnttbali/locnttbali_widget.dart';
import '../pgi/pgi_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';

class LocationntbaliWidget extends StatefulWidget {
  const LocationntbaliWidget({Key? key}) : super(key: key);

  @override
  _LocationntbaliWidgetState createState() => _LocationntbaliWidgetState();
}

class _LocationntbaliWidgetState extends State<LocationntbaliWidget> {
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LocnttbaliWidget(),
                                  ),
                                );
                              },
                              text: '\tBALI',
