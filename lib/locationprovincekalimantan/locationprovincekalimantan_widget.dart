...
import '../lockaltim/lockaltim_widget.dart';
import '../loclisttenant/loclisttenant_widget.dart';
import '../pgi/pgi_widget.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class LocationprovincekalimantanWidget extends StatefulWidget {
  const LocationprovincekalimantanWidget({Key? key}) : super(key: key);

  @override
  _LocationprovincekalimantanWidgetState createState() =>
      _LocationprovincekalimantanWidgetState();
}

class _LocationprovincekalimantanWidgetState
    extends State<LocationprovincekalimantanWidget> {
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LockaltimWidget(),
                                  ),
                                );
                              },
