...
class LocjawatengahWidget extends StatefulWidget {
  const LocjawatengahWidget({Key? key}) : super(key: key);

  @override
  _LocjawatengahWidgetState createState() => _LocjawatengahWidgetState();
}

class _LocjawatengahWidgetState extends State<LocjawatengahWidget> {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'Borobudur International Golf ',
                            options: FFButtonOptions(
                              width: 120,
                              height: 40,
