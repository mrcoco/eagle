...
class ShortcutclubWidget extends StatefulWidget {
  const ShortcutclubWidget({Key? key}) : super(key: key);

  @override
  _ShortcutclubWidgetState createState() => _ShortcutclubWidgetState();
}

class _ShortcutclubWidgetState extends State<ShortcutclubWidget> {
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          10, 40, 0, 0),
                                      child: Image.asset(
                                        'assets/images/BTSCHCLUBACT.png',
                                        width: 65,
                                        height: 87,
                                        fit: BoxFit.cover,
                                      ),
