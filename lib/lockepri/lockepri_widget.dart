...
class LockepriWidget extends StatefulWidget {
  const LockepriWidget({Key? key}) : super(key: key);

  @override
  _LockepriWidgetState createState() => _LockepriWidgetState();
}

class _LockepriWidgetState extends State<LockepriWidget> {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'Palm Springs Golf & Country Club',
                            options: FFButtonOptions(
                              width: 120,
                              height: 40,
