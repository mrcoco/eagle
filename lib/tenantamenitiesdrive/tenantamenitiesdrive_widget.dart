...
import '../trxinvoicedrive/trxinvoicedrive_widget.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class TenantamenitiesdriveWidget extends StatefulWidget {
  const TenantamenitiesdriveWidget({Key? key}) : super(key: key);

  @override
  _TenantamenitiesdriveWidgetState createState() =>
      _TenantamenitiesdriveWidgetState();
}

class _TenantamenitiesdriveWidgetState
    extends State<TenantamenitiesdriveWidget> {
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => TrxinvoicedriveWidget(),
                                ),
                              );
                            },
                            text: 'NEXT',
