...
import '../tenantcaddyteedrive/tenantcaddyteedrive_widget.dart';
...
class TenantcoachdriveWidget extends StatefulWidget {
  const TenantcoachdriveWidget({Key? key}) : super(key: key);

  @override
  _TenantcoachdriveWidgetState createState() => _TenantcoachdriveWidgetState();
}

class _TenantcoachdriveWidgetState extends State<TenantcoachdriveWidget> {
                  ...
                  Stack(
                    children: [
                      Padding(
                        ...
                        child: Image.asset(
                          'assets/images/COACH_PROFILE.png',
                          width: 320,
                          height: 420,
                          fit: BoxFit.cover,
                        ),
