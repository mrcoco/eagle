...
class MembershipUpgradePlatinumWidget extends StatefulWidget {
  const MembershipUpgradePlatinumWidget({Key? key}) : super(key: key);

  @override
  _MembershipUpgradePlatinumWidgetState createState() =>
      _MembershipUpgradePlatinumWidgetState();
}

class _MembershipUpgradePlatinumWidgetState
    extends State<MembershipUpgradePlatinumWidget> {
