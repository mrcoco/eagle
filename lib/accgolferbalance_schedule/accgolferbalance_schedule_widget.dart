...
class AccgolferbalanceScheduleWidget extends StatefulWidget {
  const AccgolferbalanceScheduleWidget({Key? key}) : super(key: key);

  @override
  _AccgolferbalanceScheduleWidgetState createState() =>
      _AccgolferbalanceScheduleWidgetState();
}

class _AccgolferbalanceScheduleWidgetState
    extends State<AccgolferbalanceScheduleWidget> {
