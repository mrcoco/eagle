...
class LocjawabaratWidget extends StatefulWidget {
  const LocjawabaratWidget({Key? key}) : super(key: key);

  @override
  _LocjawabaratWidgetState createState() => _LocjawabaratWidgetState();
}

class _LocjawabaratWidgetState extends State<LocjawabaratWidget> {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'Jagorawi Golf & Country Club\n',
                            options: FFButtonOptions(
                              width: 120,
                              height: 40,
                              color: Color(0x2B000000),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'Dago Heritage 1917 Golf Course\n',
                            options: FFButtonOptions(
                              width: 120,
                              height: 40,
                              color: Color(0x2B000000),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'Jababeka Golf & Country Club',
                            options: FFButtonOptions(
                              width: 120,
                              height: 40,
                              color: Color(0x2B000000),
