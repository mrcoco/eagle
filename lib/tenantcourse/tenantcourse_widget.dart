...
class TenantcourseWidget extends StatefulWidget {
  const TenantcourseWidget({Key? key}) : super(key: key);

  @override
  _TenantcourseWidgetState createState() => _TenantcourseWidgetState();
}

class _TenantcourseWidgetState extends State<TenantcourseWidget> {
