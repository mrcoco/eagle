...
class MembershipUpgradeGoldWidget extends StatefulWidget {
  const MembershipUpgradeGoldWidget({Key? key}) : super(key: key);

  @override
  _MembershipUpgradeGoldWidgetState createState() =>
      _MembershipUpgradeGoldWidgetState();
}

class _MembershipUpgradeGoldWidgetState
    extends State<MembershipUpgradeGoldWidget> {
