...
import '../locbanten/locbanten_widget.dart';
import '../locdkijkt/locdkijkt_widget.dart';
import '../locjawabarat/locjawabarat_widget.dart';
import '../locjawatengah/locjawatengah_widget.dart';
import '../locjawatimur/locjawatimur_widget.dart';
import '../loclisttenant/loclisttenant_widget.dart';
import '../locyogyakarta/locyogyakarta_widget.dart';
import '../pgi/pgi_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';

class LocationprovincejawaWidget extends StatefulWidget {
  const LocationprovincejawaWidget({Key? key}) : super(key: key);

  @override
  _LocationprovincejawaWidgetState createState() =>
      _LocationprovincejawaWidgetState();
}

class _LocationprovincejawaWidgetState
    extends State<LocationprovincejawaWidget> {
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LocdkijktWidget(),
                                  ),
                                );
                              },
                              text: 'DKI JAKARTA',
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LocbantenWidget(),
                                  ),
                                );
                              },
                              text: 'BANTEN',
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LocjawabaratWidget(),
                                  ),
                                );
                              },
                              text: 'JAWA BARAT',
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LocjawatengahWidget(),
                                  ),
                                );
                              },
                              text: 'JAWA TENGAH',
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LocyogyakartaWidget(),
                                  ),
                                );
                              },
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LocjawatimurWidget(),
                                  ),
                                );
                              },
                              text: 'JAWA TIMUR',
