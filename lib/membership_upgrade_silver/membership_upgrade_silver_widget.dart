...
class MembershipUpgradeSilverWidget extends StatefulWidget {
  const MembershipUpgradeSilverWidget({Key? key}) : super(key: key);

  @override
  _MembershipUpgradeSilverWidgetState createState() =>
      _MembershipUpgradeSilverWidgetState();
}

class _MembershipUpgradeSilverWidgetState
    extends State<MembershipUpgradeSilverWidget> {
