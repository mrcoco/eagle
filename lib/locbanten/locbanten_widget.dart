...
class LocbantenWidget extends StatefulWidget {
  const LocbantenWidget({Key? key}) : super(key: key);

  @override
  _LocbantenWidgetState createState() => _LocbantenWidgetState();
}

class _LocbantenWidgetState extends State<LocbantenWidget> {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'Gading Raya Padang Golf & Club',
                            options: FFButtonOptions(
                              width: 120,
                              height: 40,
