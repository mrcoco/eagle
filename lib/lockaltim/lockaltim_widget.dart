...
class LockaltimWidget extends StatefulWidget {
  const LockaltimWidget({Key? key}) : super(key: key);

  @override
  _LockaltimWidgetState createState() => _LockaltimWidgetState();
}

class _LockaltimWidgetState extends State<LockaltimWidget> {
