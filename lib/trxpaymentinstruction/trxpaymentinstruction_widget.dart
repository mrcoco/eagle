...
import '../trxwaitingpayment/trxwaitingpayment_widget.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class TrxpaymentinstructionWidget extends StatefulWidget {
  const TrxpaymentinstructionWidget({Key? key}) : super(key: key);

  @override
  _TrxpaymentinstructionWidgetState createState() =>
      _TrxpaymentinstructionWidgetState();
}

class _TrxpaymentinstructionWidgetState
    extends State<TrxpaymentinstructionWidget> {
