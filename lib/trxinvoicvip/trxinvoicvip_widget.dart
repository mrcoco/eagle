...
class TrxinvoicvipWidget extends StatefulWidget {
  const TrxinvoicvipWidget({Key? key}) : super(key: key);

  @override
  _TrxinvoicvipWidgetState createState() => _TrxinvoicvipWidgetState();
}

class _TrxinvoicvipWidgetState extends State<TrxinvoicvipWidget> {
