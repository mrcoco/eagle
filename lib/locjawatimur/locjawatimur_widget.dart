...
class LocjawatimurWidget extends StatefulWidget {
  const LocjawatimurWidget({Key? key}) : super(key: key);

  @override
  _LocjawatimurWidgetState createState() => _LocjawatimurWidgetState();
}

class _LocjawatimurWidgetState extends State<LocjawatimurWidget> {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'Golf Graha Family - Club House',
                            options: FFButtonOptions(
                              width: 120,
                              height: 40,
                              color: Color(0x2B000000),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'taman dayu golf club & resort',
                            options: FFButtonOptions(
                              width: 120,
                              height: 40,
                              color: Color(0x2B000000),
