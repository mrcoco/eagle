...
class LocationprovincesulawesiWidget extends StatefulWidget {
  const LocationprovincesulawesiWidget({Key? key}) : super(key: key);

  @override
  _LocationprovincesulawesiWidgetState createState() =>
      _LocationprovincesulawesiWidgetState();
}

class _LocationprovincesulawesiWidgetState
    extends State<LocationprovincesulawesiWidget> {
